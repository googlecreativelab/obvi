...
## Credits
This component was authored by [@nick-jonas](github.com/nick-jonas), and was built atop some great tools - special thanks to the Polymer team (esp. Chris Joel), [Jonathan Schaeffer](https://github/com/jonathanschaefferhookqa), [@jasonfarrell](https://github.com/jasonfarrell), @GersonRosales & @danielstorey for showing a working recording example in iOS11 early days.
